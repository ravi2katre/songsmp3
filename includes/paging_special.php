<?php
			...
			$numrows = count($db->query($pagingqry));
			...
			if($numrows>0)
			{
					...
					{
					   $page  = $pageNum - 1;
					   $prev  = " <a href=\"$pagelink$page$htmlpage\"><img src='previous.png' title='Previous' alt='Previous'></a>";
						$gofirst = 1;
					}
					else
					{
					...
					{
					   $page = $pageNum + 1;
					   $next = " <a href=\"$pagelink$page$htmlpage\"><img src='next.png' title='Next' alt='Next'></a> ";
